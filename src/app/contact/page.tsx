...
const description =
  "Get in touch with Danny Echeverri via LinkedIn, GitHub, email, or contact form.";
      ...
      <div className="min-h-screen w-full overflow-x-hidden bg-base-100 p-8 text-base-content">
        <div className="relative mx-auto max-w-7xl">
          ...
          <p className="mx-auto mb-12 max-w-xl text-center text-lg text-base-content/75">
            Let&#39;s connect. Reach out through the form below or any of these
            platforms.
          </p>
          ...
          <div className="mx-auto mt-12 grid max-w-3xl grid-cols-1 gap-8 md:grid-cols-3">
            ...
            >
              <div className="card-body items-center text-center">
                <svg
                  className="group-hover:text-accent-focus mb-4 h-12 w-12 text-accent transition-colors"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                >
